...
namespace WebService1
{
	...
	public class Service1 : System.Web.Services.WebService
	{
		...
		//}
		[WebMethod]
		public string GetCAE(XmlDocument xmlEmpresa, XmlDocument xmlComprobante, out string logError, out string nroComprobante, ref long idCabeceraWS)
		{
			return MFDService.MFDService.GetCAE(xmlEmpresa, xmlComprobante, out logError, out nroComprobante, ref idCabeceraWS );
		}
		[WebMethod]
		public long? GetUltimoId(XmlDocument xmlEmpresa)
		{
			return MFDService.MFDService.GetUltimoId(xmlEmpresa);
		}
		[WebMethod]
		public int? GetUltimoNroComprobante(XmlDocument xmlEmpresa, XmlDocument xmlComprobante)
		{
			return MFDService.MFDService.GetUltimoNroComprobante(xmlEmpresa, xmlComprobante);
		}
