...
{
    class GeneralSettingsImportController
    {
		protected ImportarExcel settingsForm;
        protected GeneralSettingsBL settingsLogic;

        public GeneralSettingsImportController(GeneralSettingsBL sl)
        {
            settingsLogic = sl;
			settingsForm = new ImportarExcel();
