...
namespace MFD
{
    public partial class ComprobantesCRUD : CRUDForm {
        ...
        protected void FillTotales()
        {
			...
			txtIva1.Text = Persistent.Iva1Form.ToString("#0.#0");
			txtIva2.Text = Persistent.Iva2Form.ToString("#0.#0");
			txtSubtotalAImp.Text = Persistent.SubtotalForm.ToString("#0.#0"); 
        ...
        private void PersistirUltimoComprobante(string ultimo)
        {
            if (this.action == CRUDAction.Create)
            {
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.FacturaE"])
					Persistent.Empresa.UltimaFacturaE = ultimo;
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.NotaDebitoE"])
					Persistent.Empresa.UltimaNotaDebitoE = ultimo;
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.NotaCreditoE"])
					Persistent.Empresa.UltimaNotaCreditoE = ultimo;
			}
        }
        ...
        private string ObtenerNroComprobante()
        {
			...
			try
			{
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.FacturaE"]) ultimoComprobante = Persistent.Empresa.UltimaFacturaE;
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.NotaDebitoE"]) ultimoComprobante = Persistent.Empresa.UltimaNotaDebitoE;
				...
				else if (Persistent.Tipo.Codigo == ConfigurationManager.AppSettings["tipoComprobante.NotaCreditoE"]) ultimoComprobante = Persistent.Empresa.UltimaNotaCreditoE;
				int nro;
