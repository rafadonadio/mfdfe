...
namespace Sb.Windows.Forms.StylesSheet
{
    ...
    class PropertySetter
    {
        ...
        public void Set(string styleName, Control control, string path, string value)
        {
            ...
            Object propValue = GetValueFromString(prop.PropertyType, value);
            if (propValue != null)
                prop.SetValue(lastObject, propValue, null);  	
        }
        ...
        private object GetValueFromString(Type type, string s)
        {
            if (type == typeof(Image))
            {
                ...
                if (thisExe!=null)
                {
                    System.Resources.ResourceManager rm = new System.Resources.ResourceManager("MFD.Properties.Resources", thisExe);
                    return rm.GetObject(s);
                }
                else
                    return null;
            }
